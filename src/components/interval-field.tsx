    ...
    <div className="space-y-1.5 sm:col-span-2">
      ...
      <div className="flex gap-2">
        <select
          ...
          className="flex h-8 items-center rounded-sm border border-input bg-transparent px-2.5 text-sm outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 dark:bg-input/30"
        >
