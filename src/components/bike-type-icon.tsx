...
function RoadIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 101 55" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
function GravelIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 101 60" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
function EnduranceRoadIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 101 58" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
function EnduroIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 101 61" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
function EMTBIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 101 104" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
function UrbanIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 101 59" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
function OtherBikeIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 101 90" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
