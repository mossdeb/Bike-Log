const en = {
  ...
  hero: {
    ...
    title: "Keep your bike always in top shape.",
    subtitle:
      "Log every bike, track component wear, and get alerted before problems come up. Fewer surprise breakdowns, more time riding.",
    alertsTitle: "Alerts",
    alertsSub: "Never miss a service again",
    repairsTitle: "Repairs",
    repairsSub: "Avoid costly repairs",
    ctaPrimary: "Get started free",
    ctaSecondary: "View plans",
    card1Name: "My bike",
    card1Sub: "Enduro  ·  180km",
    card2Name: "Fox 38",
    card2Sub: "Service due in 30 hours",
    card2Status: "Overdue",
    card3Title: "Current wear",
    card3Value: "180 km",
    card3Sub: "of wear",
    card4Name: "Drivetrain",
    card4Sub: "Replace in 200 km",
    card4Status: "On track",
  },
  features: {
    badge: "Features",
    ...
    plans: [
      {
        ...
        price: "€0",
        period: "forever",
        features: ["1 bike", "Up to 2 components", "Intervention history", "Maintenance alerts"],
      ...
      },
      {
        ...
        price: "€7.99",
        period: "/ month",
        features: ["Unlimited bikes", "Unlimited components", "Intervention history", "Reports and export"],
        cta: "Choose Pro",
        highlighted: false,
      },
    ],
